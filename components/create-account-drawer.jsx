...
import { Toaster } from "sonner"; // Ensure Toaster is used somewhere
...
export function CreateAccountDrawer({ children }) {
  ...
  // Show success toast when account creation succeeds
  useEffect(() => {
    if (newAccount) {
  ...
  return (
    <>
      <Toaster /> {/* Ensure this is placed at a global level */}
